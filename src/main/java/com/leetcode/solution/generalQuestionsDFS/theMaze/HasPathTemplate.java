package com.leetcode.solution.generalQuestionsDFS.theMaze;
 ...
 * 输出：false
 */
abstract public class HasPathTemplate {
    abstract public boolean hasPath(int[][] maze, int[] start, int[] destination);
}
